...
public class TMProFontReplacer : EditorWindow
 {
     private const string EditorPrefsKey = "Tools.TMProFontReplacer";
     private const string MenuItemName = "Tools/Replace TMProFonts...";
     ...
     private static string GetAssetPath(Object assetObject, string defaultExtension)
     {
         ...
         if (path.StartsWith("Library/", StringComparison.InvariantCultureIgnoreCase))
